...
export const hero = {
  ...
  subheadline:
    "I build agentic AI systems and end-to-end automation that turn manual work into recurring revenue. Dhaka-based, remote-first.",
  snapshot: [
...
export const about = {
  body: "Computer Science & Engineering student at MIST with hands-on experience building RAG systems, AI job-matching tools, multimodal model comparison apps, and freelance automation workflows. I design and deploy AI agents and automation that deliver measurable profit uplift — reducing costs, freeing teams, and accelerating growth.",
};
...
export const experience = [
  ...
  },
  {
    ...
    type: "Freelance",
    highlights: [
      "Rising Talent, 100% Job Success, $1,300+ total earnings",
  ...
  {
    role: "BSc Engineering, Computer Science",
    org: "Military Institute of Science and Technology (MIST)",
    period: "Undergraduate",
    type: "Education",
    highlights: [
      "Activities: Competitive Programming, Hackathons, Business Case Studies",
      "Strong engineering foundation in data structures, algorithms, and software architecture",
    ],
  },
];
