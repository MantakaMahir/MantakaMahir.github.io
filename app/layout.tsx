...
export const metadata: Metadata = {
  ...
  title: {
    default: "Mantaka Mahir | AI Transformation Expert",
    template: "%s | Mantaka Mahir",
  },
  description: "Goal-driven AI Transformation Expert building RAG systems, AI agents, and production automation workflows.",
  keywords: [
    "Mantaka Mahir",
  ...
  openGraph: {
    ...
    title: "Mantaka Mahir | AI Transformation Expert",
    description: "Goal-driven AI Transformation Expert building RAG systems, AI agents, and production automation workflows.",
    images: [
      {
        url: "/og-image.svg",
